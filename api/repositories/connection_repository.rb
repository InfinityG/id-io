...
class ConnectionRepository
  ...
  def get_any_existing_connection(origin_user_id, target_user_id)
    Connection.first(:$or => [{:origin_user_id => origin_user_id, :target_user_id => target_user_id},
                              {:origin_user_id => target_user_id, :target_user_id => origin_user_id}])
  end
